...
def run_postprocess_oscar(case_name, action):
    ...
    header = [
        ...
        "# To prevent Python version mismatches between login and compute nodes,",
        "# we force a fresh virtual environment build for every job.",
        "echo \"🔧 Cleaning up old virtual environment to ensure compatibility...\"",
        "rm -rf sloshing",
        "# ---------------------------------",
        "",
        "echo '------------------------------------------------------------'",
